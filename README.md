# 🐅 GPT-2 Jungle Book: Training GPT-2 from Scratch
...
- **Evaluate Coherence:** Compare the coherence, structure, and linguistic quality of generated text across models of varying sizes.
...
- **Highlight Dataset Limitations:** Showcase the challenges of training large language models on limited datasets and propose strategies to overcome them.
- **Encourage Accessibility:** Share pre-trained models and scripts to help others replicate, improve, or extend the work.
- **Promote Open Science:** Enable researchers and practitioners to explore fine-tuning or training on similar domain-specific datasets.

This experiment serves as an educational guide and benchmark for understanding the relationship between model size, dataset size, and text generation quality.
...
## 📌 **Key Insights**
1. **Best Model Size:**  
   - The **15M** model shows the best balance between structure and coherence. Larger models like 59M and 100M heavily overfit due to the limited dataset size.
